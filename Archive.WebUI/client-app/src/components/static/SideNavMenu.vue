<template>
  <div class="side-navigation-menu dx-swatch-arktika-scheme-dark-nav" @click="forwardClick">
    <slot />
...
export default {
  ...
  methods: {
    ...
    handleItemClick(e) {
      if (!e.itemData.path || this.compactMode || this.$router.currentRoute.fullPath===e.itemData.path) {
        return;
      }
